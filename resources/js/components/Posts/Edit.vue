<template>
    <form @submit.prevent="updatePost(post)">
        <div>
            ...
            <input v-model="post.title" type="text" id="post-title" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="mt-4">
            ...
            <textarea v-model="post.content" name="post-content" id="post-content" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
            <div class="text-red-600 mt-1">
        ...
        <div class="mt-4">
            ...
            <select v-model="post.category_id" id="post-category" class="block mt-1 w-full rounded-md shadow-md">
        ...
        <div>
            ...
            <input @change="post.thumbnail = $event.target.files[0]" type="file" id="thumbnail" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            <div class="text-red-600 mt-1">
